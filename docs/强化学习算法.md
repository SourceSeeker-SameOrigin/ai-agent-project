...
## 目录
- [1. 强化学习基础](#1-强化学习基础)
- [2. PPO 算法详解](#2-ppo-算法详解)
- [3. GRPO 算法详解](#3-grpo-算法详解)
- [4. TRPO 算法详解](#4-trpo-算法详解)
- [5. DPO 算法详解](#5-dpo-算法详解)
- [6. 算法对比](#6-算法对比)
- [7. 实际应用](#7-实际应用)
- [8. 代码实现](#8-代码实现)
...
1. **强化学习**：通过试错和奖励信号学习最优策略
2. **PPO**：通过概率裁剪实现稳定的策略优化
3. **GRPO**：专为 LLM 优化，不需要价值网络
4. **TRPO**：理论严谨但实现复杂
5. **DPO**：直接从偏好学习，跳过强化学习

### 9.2 生活化总结

- **强化学习**：像学骑自行车，通过不断尝试和反馈改进
...
2. **GRPO**: DeepSeek, "DeepSeek-V3 Technical Report" (2024)
3. **TRPO**: Schulman et al., "Trust Region Policy Optimization" (2015)
4. **DPO**: Rafailov et al., "Direct Preference Optimization" (2023)
