...
class TetrisApp:
    ...
    def render(self):
        ...
        # 绘制游戏画面
        self.ui.draw(game_grid, game_info, current_piece, next_piece, game_info['status'])
...
def main():
    ...
    print("=" * 50)
    print("修复内容:")
    print("1. ✅ 中文字体乱码问题 - 使用飞机大战游戏的字体初始化方法")
    print("2. ✅ 方块底部超出边界问题 - 修复碰撞检测逻辑")
    print("3. ✅ 游戏区域超出屏幕问题 - 调整游戏区域位置")
    print("=" * 50)
    print("游戏控制:")
    print("  ← → : 左右移动")
    print("  ↑ : 旋转方块")
